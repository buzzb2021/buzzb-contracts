...
import "./Buzzbtoken.sol";

// MasterChef is the master of BBF. He can make BBF and he is a fair guy.
//
// Note that it's ownable and the owner wields tremendous power. The ownership
// will be transferred to a governance smart contract once BBF is sufficiently
...
contract MasterChef is Ownable {
    ...
    struct UserInfo {
        ...
        //
        // We do some fancy math here. Basically, any point in time, the amount of BBFs
        // entitled to a user but is pending to be distributed is:
        //
        //   pending reward = (user.amount * pool.accBBFPerShare) - user.rewardDebt
        //
        // Whenever a user deposits or withdraws LP tokens to a pool. Here's what happens:
        //   1. The pool's `accBBFPerShare` (and `lastRewardBlock`) gets updated.
